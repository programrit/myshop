    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" name="id" value="<?php echo $id; ?>">
            <div class="col-md-12">
                <label for="">Name</label>
                <input type="text" class="form-control" value="<?php if(isset($rows['name'])){ echo $rows['name'];}else{ null;} ?>" name="name" required>
            </div>
            <div class="col-md-12">
                <label for="">Date of birth</label>
                <input type="date" class="form-control" value="<?php if(isset($rows['date_of_birth'])){ echo $rows['date_of_birth'];}else{ null;} ?>" name="birth" required>
            </div>
            <div class="col-md-12">
                <label for="">Address</label>
                <textarea class="form-control" name="address" required minlength="5" maxlength="100"><?php if(isset($rows['address'])){ echo $rows['address'];}else{ null;} ?>
                </textarea>
            </div>
            <div class="col-md-12">
                <label for="">Avatar</label>
                <input type="file" value="<?php if(isset($rows['avatar'])){ echo $rows['avatar'];}else{ null;} ?>" class="form-control" name="avatar">
            </div>
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="navbar-nav  py-0">
                        ...
                        $row2=$selected->fetch_assoc();
                        ?>
                        <h5 class="mt-2 ml-5 mx-auto mr-auto">Welcome <?php if(isset($row2["name"])){ echo ucfirst($row2["name"]);}else{ echo ucfirst($user1);} ?></h5>  
                    </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 576px;">
