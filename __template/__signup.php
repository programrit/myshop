...
if(isset($_POST["submit"])){
	...
	if($password==$password1){
		...
		header("Location: signup.php?exist=password dosn't match!");
...
<section class="vh-150" style="background-color: pink;">
		<div class="container-fluid py-3 h-custom">
			<div class="row d-flex">
				<div class="col-md-8">
				<img src="/my-shop/img/shopping.webp" class="h-100 w-100 rounded"  alt="Sample image">
				</div>
				<div class="col-md-3 mx-auto">
					...
					<form action="signup" method="post" class="needs-validation" novalidate>
						<h3 class="text-center py-1 mt-2">Signup</h3>
						...
						<p class="small fw-bold mt-2 pt-1 mb-0 text-center">Already account <a href="login"
