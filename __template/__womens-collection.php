...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Womens collection</span></h2>
    </div>
    <div class="row px-xl-5  pb-3">
        ...
        if(isset($_GET["sort"])){
            ...
            if($sort=="low-to-high"){
                $query="SELECT * FROM mens WHERE category='women' ORDER BY price ASC";
            ...
            <?php }
                ...
                $query="SELECT * FROM mens WHERE category='women' ORDER BY price DESC";
                $result=$conn->query($query);
                while($row=$result->fetch_array(MYSQLI_ASSOC)){?>
                    <div class="card product-item border-0 mb-4" id="main">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
            ...
            <?php }
                ...
                $query="SELECT * FROM mens WHERE category='women' ORDER BY product_id DESC";
                $result=$conn->query($query);
                while($row=$result->fetch_array(MYSQLI_ASSOC)){?>
                    <div class="card product-item border-0 mb-4" id="main">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
            ...
            <?php }
                ...
                $query="SELECT * FROM mens WHERE category='women' ORDER BY product_id ASC";
                $result=$conn->query($query);
                while($row=$result->fetch_array(MYSQLI_ASSOC)){?>
                    <div class="card product-item border-0 mb-4" id="main">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
            ...
            <?php }
                ...
                echo "<script>window.location.href=http://localhost/my-shop/womens;</script>";
            }
        }else{
