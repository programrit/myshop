...
?>
    ...
    <body>
        ...
        <!-- Page Header Start -->
        <div class="container-fluid mb-5" style="background-color: #FFF2FD;">
        ...
        <!-- Back to Top -->
        <a href="#" class="btn back-to-top" style="background-color: #FFF2FD;"><i class="fa fa-angle-double-up"></i></a>
