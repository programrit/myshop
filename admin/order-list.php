                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div class="btn-group">
                                            <button class="btn btn-primary" style="height: 30px;"><a href="order-edit?id=<?php echo base64_encode($row['order_id']); ?>" style="text-decoration: none;" class="text-white"><i class="fa-solid fa-pen-to-square"></i></a></button>
                                                <form action="" method="POST">
													<button class="btn btn-danger" onclick="return order_delete()" name="delete" type="submit" value="<?php echo $row['order_id']; ?>"><i class="fa-solid fa-trash"></i></button>
											   </form>
                                            </div>
                                            </td>
                                        </tr> 
