...
if(admin_session::get('is_login')){
	...
	if(isset($_POST["update"])){
		...
		if(empty($phone)){
			$msg1="Please fill the blank!";
		}else if($phone <10){
			$msg1="Please enter valid phone number";
		}else{
			$admin=admin::admin_update($id,$phone);
			$update=true;
		}
	}
	if($update==true && $admin==true){
		$msg="Admin data update successfully!";
                                ...
                                <form action="" method="POST" class="needs-validation" novalidate>
									...
									<input type="hidden" class="form-control" name="id" value="<?php echo $id ?>" >
										<div class="col-md-12 mb-3">
                                            <label for="">Id</label>
                                            <input type="number" class="form-control" disabled value="<?php echo $id ?>" >
                                        </div>
                                        <div class="col-md-12 mb-3">
